                      ...
                      {isMobile ? (
                        <table width="100%" cellPadding={0} cellSpacing={0}>
                          <tbody>
                            ...
                            <tr>
                              <td style={{ padding: "10px 0 14px", textAlign: "right", paddingRight: "0" }}>
                                <a href="https://rekvizitai.vz.lt/imone/belacor_invest/" target="_blank" rel="noopener noreferrer">
                                  <img src="/brands/rekvizitai-qr.png" alt="Rekvizitai" style={{ width: "90px", height: "90px", borderRadius: "12px", objectFit: "contain", aspectRatio: "1/1" }} />
                                </a>
                              </td>
                            </tr>
                            <tr>
                                ...
                                <table cellPadding={0} cellSpacing={0} style={{ width: "100%" }}>
                                  <tbody>
                                    <tr>
                                      ...
                                      <td style={{ verticalAlign: "top", paddingLeft: "100px" }}>
                                        <a href="https://rekvizitai.vz.lt/imone/belacor_invest/" target="_blank" rel="noopener noreferrer">
